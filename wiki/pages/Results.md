...
→ Added JT2 (25 uL)
→ KM(2 uL)
→ Metaazazazazazzzazzssasas (100 uL)
Growth
4
Negative
...
The growth of  of NCM as a positive in control in trial 2 was expected, and was done to confirm that there would be no adverse factors from the removal of NCM that were causing the introduced J2T to not be able to grow, and that the composition of the media was static.
